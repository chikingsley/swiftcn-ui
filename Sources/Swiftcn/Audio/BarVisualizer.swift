...
#Preview("BarVisualizer · states") {
    @Previewable @State var state: SCAgentState = .listening
    SCPreview {
        VStack(spacing: 20) {
            SCBarVisualizer(state: state, barCount: 20, minHeight: 15, maxHeight: 90, demo: true, height: 160)
            HStack(spacing: 8) {
...
#Preview("BarVisualizer · center aligned") {
    SCPreview {
        SCBarVisualizer(state: .speaking, demo: true, centerAlign: true)
            .padding()
    }
}

#Preview("BarVisualizer · idle") {
    SCPreview {
        SCBarVisualizer(demo: true)
            .padding()
    }
}
