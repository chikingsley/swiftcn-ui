...
private enum SCDropdownMenuPreviewPosition: String, CaseIterable, Hashable {
    case top
    case bottom
    case right
}

#Preview("Dropdown menu · complete") {
    @Previewable @State var showStatusBar = true
    @Previewable @State var selectedPosition = SCDropdownMenuPreviewPosition.bottom
                ...
                SCDropdownMenuContent {
                    SCDropdownMenuGroup("My Account") {
                        SCDropdownMenuItem(
                            ...
                            action: { lastAction = "Profile" },
                            label: { Label("Profile", systemImage: "person") }
                        )
                        SCDropdownMenuItem("Billing") {
                            lastAction = "Billing"
                        }
                        SCDropdownMenuItem("API", isDisabled: true) {}
                    }
                    ...
                    SCDropdownMenuRadioGroup(
                        ...
                        ForEach(SCDropdownMenuPreviewPosition.allCases, id: \.self) { position in
                            SCDropdownMenuRadioItem(
                                position.rawValue.capitalized,
                                value: position,
                                isDisabled: position == .right
                            )
                        }
                    }
                    SCDropdownMenuSub {
                        ...
                        SCDropdownMenuSubContent {
                            SCDropdownMenuItem("Email") { lastAction = "Email" }
                            SCDropdownMenuItem("Message") { lastAction = "Message" }
                        }
                    }
                    SCDropdownMenuSeparator()
                    SCDropdownMenuItem(
