// ============================================================
// NavigationDemos.swift — Swiftcn macOS Showcase
...
struct SidebarComponentDemo: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            Text(
                """
                This app's shell is an SCSidebarLayout — the demo below embeds a second, self-contained one. \
                Toggle it with its trigger or drag its rail.
                """
            )
            .scMuted()
            miniSidebar
    ...
    private var miniSidebar: some View {
        SCSidebarLayout(
            ...
            SCSidebarContent {
                ...
                SCSidebarGroup {
                    HStack(spacing: 4) {
                        SCSidebarGroupLabel { Text("Projects") }
                        Spacer()
                        ...
                        SCSidebarMenu {
                            SCSidebarMenuItem {
                                ...
                                SCSidebarMenuAction(
                                    ...
                                    action: {},
                                    content: { Image(systemName: "ellipsis") }
                                )
                            }
...
#Preview("Navigation · Breadcrumb") { ShowcasePreview { BreadcrumbDemo() } }
#Preview("Navigation · Command") { ShowcasePreview { CommandDemo() } }
#Preview("Navigation · Pagination") { ShowcasePreview { PaginationDemo() } }
#Preview("Navigation · Tabs") { ShowcasePreview { TabsDemo() } }
#Preview("Navigation · Sidebar") { ShowcasePreview(width: 1100) { SidebarComponentDemo() } }
