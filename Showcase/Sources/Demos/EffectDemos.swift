// ============================================================
// EffectDemos.swift — Swiftcn macOS Showcase
...
struct ScrollFadeDemo: View {
    @Environment(\.theme) private var theme

    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            DemoSection("Vertical · both edges") {
                ScrollView {
                    VStack(spacing: 6) {
            ...
            DemoSection("Horizontal") {
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 8) {
                        ForEach(["SwiftUI", "SwiftData", "Metal", "Combine", "WidgetKit", "TestFlight"], id: \.self) {
                            SCBadge($0, variant: .secondary)
                        }
                    }
...
#Preview("Effect · Aurora") { ShowcasePreview { AuroraDemo() } }
#Preview("Effect · Dot Pattern") { ShowcasePreview { DotPatternDemo() } }
#Preview("Effect · Marquee") { ShowcasePreview { MarqueeDemo() } }
#Preview("Effect · Number Ticker") { ShowcasePreview { NumberTickerDemo() } }
#Preview("Effect · Scroll Fade") { ShowcasePreview { ScrollFadeDemo() } }
#Preview("Effect · Shimmer") { ShowcasePreview { ShimmerDemo() } }
#Preview("Effect · Shimmer Button") { ShowcasePreview { ShimmerButtonDemo() } }
