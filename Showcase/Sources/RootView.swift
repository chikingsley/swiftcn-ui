// ============================================================
// RootView.swift — Swiftcn macOS Showcase
...
private struct SidebarFooterLink: View {
    ...
    var body: some View {
        HStack(spacing: 8) {
            ...
            if !sidebar.isIconCollapsed {
                Text("swiftcn-ui · local workspace")
                    .font(.caption)
                    .lineLimit(1)
...
/// Shared macOS canvas stage for every Showcase demo file.
struct ShowcasePreview<Content: View>: View {
